...
from Approach2.approach2_pipeline import load_trained_approach2
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reload and evaluate a completed Approach 2 run."
    )
...
def main() -> None:
    args = parse_args()
    config, candidates, main_model, timesteps = load_trained_approach2(args.run_dir)
